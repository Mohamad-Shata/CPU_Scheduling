...
public class FCAI_Scheduler
{
    public void schedule(List<Process> processes)
    {
        ...
        while (completed < n)
        {
            ...
            executionLog.add("P" + current.id + " starts execution, runs for " + executeTime + " units.");
            time += executeTime;
            ...
            if (current.remainingTime == 0)
            {
                ...
                executionLog.add("P" + current.id + " completes execution.");
            } else {
                ...
                pq.add(current);
                executionLog.add("P" + current.id + " is preempted with " + current.remainingTime + " units remaining.");
            }
        }
